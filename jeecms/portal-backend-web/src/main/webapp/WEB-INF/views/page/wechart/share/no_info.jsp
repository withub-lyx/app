...
<head>
    ...
    <title>查看信息</title>
    <meta name="keywords" content="查看信息">
    <meta name="description" content="查看信息">
...
<div class="middle-box text-center animated fadeInDown" style="height: 100%;">
    <h3 class="font-bold" style="margin-top:45%">您还未填写信息</h3>
    <div class="error-desc">
        请填写信息
    </div>
    <h5>
        <%--<button type="button" class="btn btn-w-m btn-primary"  onclick="window.location.href='${ctx}/front/collectinfo/index';">填写信息</button>--%>
        <button type="button" class="btn btn-w-m btn-primary"  onclick="window.location.href='${ctx}/front/share/ace74d91225d4022b5b37d439831eb06';">填写信息</button>
    </h5>
</div>
