                            ...
                            <div>
                                ...
                                <form id="queryForm" class="form-inline">
                                    <div class="form-group">
                                        <label class="control-label sr-only">组名称：</label>
                                        <input name="name" type="text" placeholder="请输入组名称" class="form-control">
                                    </div>
                                    <div class="form-group">
    ...
    $(function(){
                ...
                columns: [
                 ...
                 , {//操作
                        ...
                        <%--<shiro:hasPermission name="auth_user:8">--%>
                            ...
                            array.push('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="user" href="javascript:void(0)" title="角色"><i class="glyphicon glyphicon-user"></i></a>')
                        <%--</shiro:hasPermission>--%>
                            return array.join('');
                        },
                        events: {
        ...
        function deleteMethod(ids) {
            swal({
                ...
                auth_global.commonAjax('${ctx}/team/deleteAjax', function (data, msg) {
                    auth_global.tableUtil.selectPage($table,1);
        ...
        function configRoles(id) {
            var url = '${ctx}/team/teamUser?id='+id;
            var title = '用户设置';
