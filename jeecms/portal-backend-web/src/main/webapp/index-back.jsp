...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="${ctx}/resource/img/profile_small.jpg" /></span>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="${ctx}/resource/index_v1.html" data-index="0">主页示例一</a>
                        </li>
                        <li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="${ctx}/resource/graph_echarts.html">百度ECharts</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="${ctx}/resource/graph_flot.html">Flot</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="${ctx}/resource/graph_morris.html">Morris.js</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="${ctx}/resource/graph_rickshaw.html">Rickshaw</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="${ctx}/resource/graph_peity.html">Peity</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="${ctx}/resource/graph_sparkline.html">Sparkline</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="${ctx}/resource/graph_metrics.html">图表组合</a>
                        </li>
                    </ul>
                </li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-messages">
                            <li class="m-t-xs">
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="${ctx}/resource/img/a7.jpg">
                                    </a>
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="${ctx}/resource/img/a4.jpg">
                                    </a>
                                    <div class="media-body ">
                    ...
                    <li class="hidden-xs">
                        <a href="${ctx}/resource/index_v1.html" class="J_menuItem" data-index="0"><i class="fa fa-cart-arrow-down"></i> 购买</a>
                    </li>
        ...
        <div class="row content-tabs">
            ...
            <nav class="page-tabs J_menuTabs">
                <div class="page-tabs-content">
                    <a href="javascript:;" class="active J_menuTab" data-id="${ctx}/resource/index_v1.html">首页</a>
                </div>
            </nav>
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${ctx}/resource/index_v1.html?v=4.0" frameborder="0" data-id="index_v1.html" seamless></iframe>
        </div>
        <div class="footer">
                ...
                <div id="tab-2" class="tab-pane">
                    ...
                    <div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${ctx}/resource/img/a1.jpg">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${ctx}/resource/img/a2.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${ctx}/resource/img/a3.jpg">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${ctx}/resource/img/a4.jpg">
                                </div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${ctx}/resource/img/a8.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${ctx}/resource/img/a7.jpg">
                                </div>
                                <div class="media-body">
...
<!-- 自定义js -->
<script src="${ctx}/resource/js/hplus.js?v=4.1.0"></script>
<script type="text/javascript" src="${ctx}/resource/js/contabs.js"></script>
